"""permaplate_16758 URL Configuration
...
admin.site.site_header = "Permaplate"
admin.site.site_title = "Permaplate Admin Portal"
admin.site.index_title = "Permaplate Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Permaplate API",
        default_version="v1",
        description="API documentation for Permaplate App",
    ),
    public=True,
